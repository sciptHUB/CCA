...
Save Coefficient values Table S5
```{r}
setwd('C:/Users/patipark/Dropbox/CCA project/CCA RNA-seq/NewGeneSet_Module_InitialAnalysis/Figure_5A_files')
...
myFigS7E.100pt.Coef <- ggplot(ptcounts,
                aes(x = pred.class,
                    y = percent,
                    fill = molec.class,
...
myFig6D.Aspt.Coef <- ggplot(ptcounts,
                aes(x = pred.class,
                    y = percent,
                    fill = molec.class,
                    label = paste0(sprintf("%0.0f", round(percent, digits = 1)),'%'))) +
...
myFig6E.nonAspt.Coef <- ggplot(ptcounts,
                aes(x = pred.class,
                    y = percent,
                    fill = molec.class,
                    label = paste0(sprintf("%0.0f", round(percent, digits = 1)),'%'))) +
...
myFig6E.nonAspt.Coef
```

Save Figure 6E distribution of molecular subtypes in drug subgroups for non-Asian patients
```{r}
setwd('C:/Users/patipark/Dropbox/CCA project/CCA RNA-seq/NewGeneSet_Module_InitialAnalysis/Figure_5A_files')
...
myFigS7F.Ovpt.Coef <- ggplot(ptcounts,
                aes(x = pred.class,
                    y = percent,
                    fill = molec.class,
                    label = paste0(sprintf("%0.0f", round(percent, digits = 1)),'%'))) +
...
Save Figure S7F distribution of molecular subtypes in drug subgroups for Ov-infected patients
```{r}
setwd('C:/Users/patipark/Dropbox/CCA project/CCA RNA-seq/NewGeneSet_Module_InitialAnalysis/Figure_5A_files')
